...
Five years later, I was still using the same keyboard! It's amazing!
...
I ended up adding a lot of features into the bottom case, and I'll be publishing the model soon on Thingiverse to show off (a.k.a. - to share back to the community lol)
...
I still love my layers, mouse, ESDF, etc.
